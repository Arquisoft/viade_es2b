  ...
  return (
    <HomeWrapper data-testid="home-wrapper">
      <HomeSidenav className="home-sidebar">
        <h2>{t("home.routes")}</h2>
        <RouteList privateRoutesText={t("home.private_routes")} publicRoutesText={t("home.public_routes")} setRoute={props.setRoute} changeEditForm={props.changeEditForm}></RouteList>
